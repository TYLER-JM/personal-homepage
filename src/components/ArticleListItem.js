    ...
    >
      <div className="article-header">
        ...
        <div className="arrow" onClick={() => handleClick()}>
          ...
          <div className={classNames("left", {open: !selected, close: selected})}></div>
          <div className={classNames("right", {open: !selected, close: selected})}></div>
          {/* <div className="right open"></div> */}
        </div>
        <p className="preview-text">this is thumbnail text. The article is so great you'l...</p>
      </div>
